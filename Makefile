bleep: parser.o game.o object.o star.o maths.o kinetics.o sounds.o asteroid.o graphics.o player.o bleep.o
	g++ -g -std=c++17 -o bleep ./game.o ./parser.o ./kinetics.o ./asteroid.o ./sounds.o ./player.o ./graphics.o ./maths.o ./object.o ./star.o ./bleep.o -lasound -lpthread -lpng -lGL -lX11
...
clean:
	rm -f bleep parser.o game.o object.o star.o maths.o kinetics.o sounds.o asteroid.o graphics.o player.o bleep.o
